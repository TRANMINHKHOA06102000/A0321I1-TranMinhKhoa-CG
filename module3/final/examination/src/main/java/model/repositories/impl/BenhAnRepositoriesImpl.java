...
public class BenhAnRepositoriesImpl implements BenhAnRepositories {
    ...
    private static final String DELETE_SQL = "delete from benh_an where benh_an.ma_benh_an =?;";
    private static final String UPDATE_SQL = "update benh_an set ma_benh_nhan = ?, " +
            "ngay_nhap_vien = ?, ngay_ra_vien = ?,ly_do = ? where ma_benh_an = ?;";
    private static final String FIND_BY_ID = "select * from benh_an where ma_benh_an = ?;";
        ...
        if (connection != null) {
            try {
                ...
                while (resultSet.next()) {
                    ...
                    list.add(new BenhAn(ma_benh_an, ma_benh_nhan, ten_benh_nhan, ngay_nhap_vien, ngay_ra_vien, ly_do));
                }
